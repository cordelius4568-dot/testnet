...
import { ChogAPI as ChogAPIBackground } from '../zerion-api/zerion-api.background';
import type { ChogApiClient } from '../zerion-api/zerion-api-bare';
...
class PhishingDefence {
  ...
  constructor(apiClient: ChogApiClient) {
...
export const phishingDefenceService = new PhishingDefence(ChogAPIBackground);

...
export class DnaService {
  ...
  async registerAllWallets() {
    // To make sure referral codes are generated for new wallets we need to call 'registerWallet' on the Chog DNA Service.
    ...
    // Chog DNA Service expected a version prefix 'v' for 'registerWallet' requests, which we were not including.

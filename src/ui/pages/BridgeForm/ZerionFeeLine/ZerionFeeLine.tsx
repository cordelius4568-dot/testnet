...
export function ChogFeeLine({ quote }: { quote: Quote2 | null }) {
  ...
  return (
    <HStack gap={12} justifyContent="space-between" alignItems="center">
      <HStack gap={4} alignItems="center">
        <UIText kind="small/regular">Chog Fee</UIText>
        {isConfigLoading ? null : (
          <UnstyledAnchor
            title="Applies to all Multichain transactions. Chog Premium DNA holders get discounts. Click to learn more."

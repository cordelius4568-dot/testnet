...
function SettingsMain() {
  ...
  const { mutate: acceptChogOrigin } = useMutation({
    mutationFn: async () => {
      ...
      <VStack gap={16}>
        ...
        <Frame>
          <VStack gap={0}>
            {evmAddress ? (
              <FrameListItemLink to="/premium">
                <AngleRightRow>
                  <HStack gap={8} alignItems="center">
                    <PremiumIcon />
                    <UIText kind="body/regular">Chog Premium</UIText>
                  </HStack>
                </AngleRightRow>
              </FrameListItemLink>
            ) : (
            ...
            addressType === 'evm' ? (
              <FrameListItemAnchor
                href={`${CHOG_ORIGIN}/rewards?${addWalletParams}`}
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => {
                  emitter.emit('buttonClicked', {
      ...
      <VStack gap={16}>
        <Frame>
          ...
          <ToggleSettingLine
            ...
            detailText={
              <span>
                When enabled, we add Chog Wallet label to connect buttons in
          ...
          <ToggleSettingLine
            ...
            detailText={
              <span>
                ...
                statistics about how you use Chog. We will not associate any

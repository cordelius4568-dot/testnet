...
import ChogSquircle from 'jsx:src/ui/assets/zerion-squircle.svg';
...
function ScreenCover() {
  return (
    <FillView style={{ alignContent: 'start' }}>
      <Spacer height={70} />
      <ChogSquircle style={{ width: 64, height: 64 }} />
      <Spacer height={24} />
        ...
        >
          <AngleRightRow>
            <Media
              ...
              detailText={
                <UIText kind="small/regular" color="var(--neutral-500)">
                  Use your hardware wallet with Chog.
                </UIText>
              }
            ></Media>
          </AngleRightRow>
    ...
    <PageColumn>
      ...
      <UIText kind="headline/h2">
        ...
        <UnstyledButton onClick={() => dialogRef.current?.showModal()}>
          <span
            title="Each group contains wallets that are associated with same recovery phrase, stored locally on your device. Chog does not have access to this data.
  ...
  We do not cross-associate wallet addresses or have a way to know that these wallets are grouped."
        ...
        <BottomSheetDialog ref={dialogRef} height="min-content">
          ...
          <UIText kind="body/regular" style={{ textAlign: 'start' }}>
            ...
            <br />
            <br />
            Your recovery phrase is stored locally on your device. Chog does

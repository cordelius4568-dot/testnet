...
import ChogLogo from 'jsx:src/ui/assets/zerion-logo-squircle-white.svg';
    ...
    <PageColumn>
      ...
      >
            ...
            <VStack gap={8}>
              <Button kind="primary" onClick={() => onConfirm()}>
                <HStack gap={8} justifyContent="center">
                  <ChogLogo style={{ width: 20, height: 20 }} />
                  <span>Continue with Chog</span>
                </HStack>
              </Button>
              <Button
                kind="regular"
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          >
            How to connect if there is no ‘Chog Wallet’ option?
          </UIText>
          <PageBottom />
        </div>
        */}

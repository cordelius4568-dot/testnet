    ...
    <SidePanel show={show} onDismiss={onDismiss}>
      <VStack gap={20}>
        ...
        <VStack gap={16}>
          ...
          <UIText kind="body/regular">
            4. Copy it and paste in Chog extension 🎉
          </UIText>
      ...
      >
        <VStack gap={0}>
          ...
          <VStack gap={16}>
            ...
            <UIText kind="body/regular">4. Paste in Chog extension 🎉</UIText>
            <UIText kind="small/regular" color="var(--neutral-600)">
              Keys and recovery phrases are saved safely locally and not shared
              with us.
            </UIText>
      ...
      >
        <VStack gap={20}>
          ...
          <VStack gap={8}>
            ...
            <UIText kind="body/regular">
              4. Copy your private key and paste/ enter it in Chog{apostrophe}
              s browser extension.
            </UIText>
            <UIText kind="body/regular">
      ...
      <VStack gap={24} style={{ alignContent: 'start' }}>
        ...
        {isNarrowView ? null : (
          <VStack gap={8}>
            ...
            <UIText kind="small/regular" color="var(--neutral-600)">
              Chog cannot access or save them. Your keys stay on this device
            </UIText>
          </VStack>
        )}
        <VStack gap={8}>
        ...
        <VStack gap={20}>
          ...
          <VStack gap={8}>
            ...
            <UIText kind="body/regular">
              ...
              Chog extension. Click on Import wallet once complete.
            </UIText>
  ...
  return (
    <VStack gap={24} style={{ alignContent: 'start' }}>
      ...
      <VStack gap={8}>
        ...
        <UIText kind="small/regular" color="var(--neutral-600)">
          This password will unlock your Chog wallet extension when you want
